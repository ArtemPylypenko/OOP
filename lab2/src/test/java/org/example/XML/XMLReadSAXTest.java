...
class XMLReadSAXTest {

    @Test
    void read() throws IOException, ParserConfigurationException, TransformerException, SAXException {
        ...
        assertEquals(Arrays.toString(deposits.toArray()), Arrays.toString(XMLReadSAX.read("test.xml").toArray()));
    }
}